...
<div class="parallax parallax-fond">
    <div data-offset="35" class="decors decors-layer5" style="background-image: url(<?php echo site_url(); ?>/wp-content/themes/thatmuch-wordpress/assets/images/fond-etoile-2.png);"></div>
